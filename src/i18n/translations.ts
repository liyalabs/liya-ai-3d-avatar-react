...
export const translations: Record<SupportedLocale, Translations> = {
  tr: {
    ...
    browser: {
      ...
      unsupportedMessage:
        "Bu widget tarayıcınızda çalışmıyor. 3D avatar için WebGL desteği gereklidir.",
    ...
    errors: {
      ...
      upgradeToPremium:
        "3D Avatar Widget kullanmak için Premium veya Premium Plus planına yükseltin.",
      upgradeToPremiumPlus:
        "Özel 3D avatar yüklemek için Premium Plus planına yükseltin.",
    },
    settings: {
      title: "Ayarlar",
  ...
  en: {
    ...
    browser: {
      ...
      unsupportedMessage:
        "This widget does not work in your browser. WebGL support is required for 3D avatar.",
    ...
    errors: {
      ...
      upgradeToPremium:
        "Upgrade to Premium or Premium Plus to use the 3D Avatar Widget.",
      upgradeToPremiumPlus:
        "Upgrade to Premium Plus to upload custom 3D avatars.",
    },
    settings: {
      title: "Settings",
  ...
  zh: {
    ...
    browser: {
      ...
      unsupportedMessage:
        "此小部件无法在您的浏览器中运行。3D 头像需要 WebGL 支持。",
    ...
    errors: {
      ...
      upgradeToPremium:
        "请升级到 Premium 或 Premium Plus 套餐以使用 3D 头像小部件。",
